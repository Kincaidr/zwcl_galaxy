...
def zwcl_main( argv ):
    ...
    int_image=fits_files+'mypipelinerun_ZwCl2341_1_p_0000_4-MFS-image.pb_corr.fits'#'mypipelinerun_ZwCl2341_1_p_0000_4-MFS-image.fits'
...
def A2631_main( argv ):
    ...
    simulation_path=cluster_name+'/sumulated/'
    ...
    int_image=fits_files+'mypipelinerun_ABELL2631_4-MFS-image.pb_corr.fits'#'mypipelinerun_ABELL2631_4-MFS-image.fits'#'image_DI_Clustered.DeeperDeconv.AP4.int.restored.fits'
...
def combine_main( argv ):
    ...
    combined_MeerKAT_cat=fits_files+'MeerKAT_combined.fits'
...
def  plotting_scripts(output_path,fits_files,simulation_path,cluster_name,radio_catalogue_fits,radio_optical_catalog,cluster_centre,app_image,int_image,res_image,fits_image,tessel_region,rms_image,radio_HSC_catalog):
   ...
   # write_catalog_20sigma(fits_files,cluster_name,app_image,int_image)
    ...
    complteness(simulation_path,radio_catalogue_fits)
