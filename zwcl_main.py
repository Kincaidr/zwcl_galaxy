...
import sys
from zwcl2341_plots import circle, redshift_distribution,cluster_members,zwcl_galaxy_distribution,velocity_dispersion,redshift_plots,radio_SFR_plots,RA_DEC_seperation,AGN_relation,SDSS_DeCALS,colour_colour,circle,R_200_to_deg
...
def zwcl_main( argv ):
    ...
    R_200=  R_200_to_deg(1.62,0.27)#5 Mpc
...
def A2631_main( argv ):
    ...
    SDSS_catalogue_fits = fits.open(r'A2631_DeCALS_SDSS.fits')
    SDSS_catalogue=SDSS_catalogue_fits[1].data
    ...
    galaxy_dec=SDSS_catalogue['dec_1']
    zph=SDSS_catalogue['z_spec']
    zsp=np.asarray(SDSS_catalogue['zsp'])
    ...
    radio_SDSS_catalogue = fits.open(r'A2631_DeCALS_radio.fits')
    radio_SDSS_catalogue=radio_SDSS_catalogue[1].data
    ...
    R_200=  R_200_to_deg(1.93,0.27)#5 Mpc
